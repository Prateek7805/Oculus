...
:root{
	--fontSizeLarge : 1.5em;
	--fontSizeSmall : 1.2em;
	--tableHeaderFontL : 1.1em;
	--tableBodyFontL : 0.9em;
	--tableHeaderFontS : 0.9em;
	--tableBodyFontS : 0.7em;
	--dot-online: #81B214;
	--dot-offline: #FF2626;
	--dot-reconn: #FFCC29;
	--progressOuter : #602080;
	--progressInner: #7BC74D;
}
.darkMode {
	--background: #393E46;
	--title: #EEEEEE;
...
.table-head{
	color: var(--text);
	font-size: var(--tableHeaderFontL);
	padding:10px;
}
.table-body{
	color:var(--text);
	font-size: var(--tableBodyFontL);
}
.table-body >td, .table-head > th{
	padding:10px;
	text-align: center;
}
.table, .table-body >td, .table-head > th{
...
.progress > div{
   display: table;
    ...
    height: 4px;
    border-radius: 2px;
    background-color: var(--progressOuter);
}
.progress > div > div{
    display: table;
    width: 0%;
